...
public class Interpolation
{
    ...
    public static float Interpolate(float start, float end, float value, EaseType easeType)
    {
        EasingFunction easingFunction = GetEasingFunction(easeType);
        return easingFunction(start, end, value);
    }
    ...
    public static float Spring(float start, float end, float value)
    {
        ...
        value = (Mathf.Sin(value * (float)Mathf.PI * (0.2f + 2.5f * value * value * value)) * Mathf.Pow(1f - value, 2.2f) + value) * (1f + 1.2f * (1f - value));
        return start + (end - start) * value;
    }
    ...
    public static float EaseInSine(float start, float end, float value)
    {
        ...
        return (0f - end) * Mathf.Cos(value / 1f * ((float)Mathf.PI / 2f)) + end + start;
    }

    public static float EaseOutSine(float start, float end, float value)
    {
        end -= start;
        return end * Mathf.Sin(value / 1f * ((float)Mathf.PI / 2f)) + start;
    }

    public static float EaseInOutSine(float start, float end, float value)
    {
        end -= start;
        return (0f - end) / 2f * (Mathf.Cos((float)Mathf.PI * value / 1f) - 1f) + start;
    }
    ...
    public static float EaseInElastic(float start, float end, float value)
    {
        ...
        return 0f - num4 * Mathf.Pow(2f, 10f * (value -= 1f)) * Mathf.Sin((value * num - num3) * ((float)Mathf.PI * 2f) / num2) + start;
    }
    ...
    public static float EaseOutElastic(float start, float end, float value)
    {
        ...
        return num4 * Mathf.Pow(2f, -10f * value) * Mathf.Sin((value * num - num3) * ((float)Mathf.PI * 2f) / num2) + end + start;
    }
    ...
    public static float EaseInOutElastic(float start, float end, float value)
    {
        ...
        if (value < 1f)
        {
            return -0.5f * (num4 * Mathf.Pow(2f, 10f * (value -= 1f)) * Mathf.Sin((value * num - num3) * ((float)Mathf.PI * 2f) / num2)) + start;
        }
        return num4 * Mathf.Pow(2f, -10f * (value -= 1f)) * Mathf.Sin((value * num - num3) * ((float)Mathf.PI * 2f) / num2) * 0.5f + end + start;
    }
}
